        ...
        <div class="col-lg-8">
          <div class="breadcrumb_iner">
            <div class="breadcrumb_iner_item">
              ...
              <p>Trang chủ <span>-</span>Giỏ hàng của bạn</p>
            </div>
          </div>
        </div>
      </div>
        ...
        ?>
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <h5>{{number_format($v_content->qty*$v_content->price)}} VNĐ
                 </h5>
                </td>
              ...
              <tr class="shipping_area">
                ...
                <div class="shipping_box">
                   ...
                   <ul class="list">
                     <li>
                       <p>Tạm tính: {{Cart::subtotal()}} VNĐ</p>
                     </li>
                     <li>
                       <p>Phí vận chuyển: Free</p>
                     </li>
                     <li>
                       <p>Thuế (VAT): {{Cart::tax()}} VNĐ</p>
                     </li>
                     <li class="active">
                       <p>Tổng tiền thanh toán: {{Cart::total()}} VNĐ</p>
                     </li>
                   </ul>
          ...
          <div class="checkout_btn_inner float-right">
            ...
            <?php
                        ...
                        if($customer_id!=null){                        
                        ?>
                         <a class="btn_1 checkout_btn_1" href="{{URL::to('Checkout')}}">Thanh toán</a>
                          <?php
                        }else{?>
                         <a class="btn_1 checkout_btn_1" href="{{URL::to('login-checkout')}}">Thanh toán</a>
                          <?php
                        }?>
